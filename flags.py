...
tf.app.flags.DEFINE_string('test_mode', os.environ["test_mode"], 'test mode of the seq2seq model')
...
tf.app.flags.DEFINE_integer('max_to_keep', int(os.environ["max_to_keep"]), 'max model to keep')
